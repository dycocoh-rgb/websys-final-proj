...
<div class="page-header">
  <h1><i class="bi bi-clipboard2-pulse-fill"></i> My Appointments</h1>
...
<div class="grid-2" style="margin-bottom:24px">
  <div class="card">
    <div class="card-title"><i class="bi bi-calendar-event-fill"></i> Book New Appointment</div>
    <form method="POST">
  ...
  <div class="card">
    <div class="card-title"><i class="bi bi-droplet-fill" style="color:var(--red)"></i> Donor Info</div>
  ...
  <div class="table-wrap">
    <table>
      ...
      <tbody>
        ...
        <tr><td colspan="5"><div class="empty"><div class="empty-icon"><i class="bi bi-clipboard2-pulse-fill"></i></div><p>No appointments yet</p></div></td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
