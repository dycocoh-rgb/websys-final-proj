    ...
    <nav>
      <?php if ($is_admin_page): ?>
        ...
        <a href="/blood-bank/admin/appointments.php" class="nav-item <?= $current_page==='appointments.php'?'active':'' ?>">
          <i class="bi bi-clipboard2-pulse-fill"></i><span>Appointments</span>
        </a>
        ...
        <a href="/blood-bank/admin/feedback.php" class="nav-item <?= $current_page==='feedback.php'?'active':'' ?>">
          <i class="bi bi-chat-dots-fill"></i><span>Feedback</span>
        </a>
      <?php else: ?>
        <div class="nav-section">Main</div>
        ...
        <a href="/blood-bank/donor-register.php" class="nav-item <?= $current_page==='donor-register.php'?'active':'' ?>">
          <i class="bi bi-droplet-fill"></i><span>Become a Donor</span>
        </a>
        <a href="/blood-bank/appointments-users.php" class="nav-item <?= $current_page==='appointments-users.php'?'active':'' ?>">
          <i class="bi bi-clipboard2-pulse-fill"></i><span>My Appointments</span>
        </a>
  ...
  <div class="main">
    <div class="topbar">
      ...
      <div class="topbar-right">
        <?php if ($is_admin_page): ?>
          <a href="/blood-bank/admin/index.php" class="btn btn-sm btn-secondary"><i class="bi bi-gear-fill"></i> Admin</a>
        <?php else: ?>
          <a href="/blood-bank/admin/index.php" class="btn btn-sm btn-secondary" style="<?= isAdmin()?'':'display:none' ?>"><i class="bi bi-gear-fill"></i> Admin Panel</a>
        <?php endif; ?>
        <div class="user-chip">
