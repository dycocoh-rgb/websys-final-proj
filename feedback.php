...
?>
<div class="page-header"><h1><i class="bi bi-chat-dots-fill"></i> User Feedback</h1><p><?= count($feedback) ?> feedback entries</p></div>
<div style="display:flex;flex-direction:column;gap:12px">
  ...
  <div class="empty"><div class="empty-icon"><i class="bi bi-chat-dots-fill"></i></div><p>No feedback yet</p></div>
  <?php endif; ?>
</div>
